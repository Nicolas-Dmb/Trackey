...
function DetailCommonKey({setTitle}){
    //Auth
        ...
        <div className='Main'>
            <div className='lien'>
                ...
                <div className='lien-right'>
                    <Link to={`/Copropriete/${IdCopropriete}/CommonKey/${IdKey}/Modif`} state={{key,copropriete}} className='modif'><button>Modifier la clé</button></Link>
                    <Link to={`/Copropriete/${IdCopropriete}/CommonKey/${IdKey}/Delete`} state={{key,copropriete}} className='delete'><button>Supprimer la clé</button></Link>
                </div>
            </div>
            <div className='firstFloor'>
                ...
                <button onClick={()=>downloadCommonQRCode(copropriete, key)}>Imprimer l'étiquette</button>
            </div>
